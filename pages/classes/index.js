...
import { getAllTitlesAndDashedNamesSuperblockJSONArray } from '../../util/api_proccesor';
...
export async function getServerSideProps(ctx) {
  ...
  // Replaced deprecated FCC endpoint with local mock-backed utility
  const superblocks = await getAllTitlesAndDashedNamesSuperblockJSONArray();
  const blocks = superblocks.map((x, i) => ({
    value: i,
    label: x.dashedName,
    displayName: x.title
  }));
